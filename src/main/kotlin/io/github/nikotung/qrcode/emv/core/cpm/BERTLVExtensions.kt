...
fun BERTLV.tagClass() = io.github.nikotung.qrcode.emv.core.cpm.TagClass.entries.first { it.i == byteArrayTag()[0].toInt() and io.github.nikotung.qrcode.emv.core.cpm.CLASS_BITMASK }

fun BERTLV.dataType() = io.github.nikotung.qrcode.emv.core.cpm.DataType.entries.first { it.i == (byteArrayTag()[0].toInt() and io.github.nikotung.qrcode.emv.core.cpm.TYPE_BITMASK) }